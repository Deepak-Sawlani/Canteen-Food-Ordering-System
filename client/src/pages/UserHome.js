...
// 👇 Pehle DB ka imageUrl check karo, phir hardcoded, phir emoji fallback
...
function UserHome() {
  ...
  useEffect(() => {
    axios
      .get("https://canteen-food-ordering-system-midh.onrender.com/api/menu")
    ...
    <div>
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <h3 style={{ margin: "5px 0" }}>Total Price: ₹{calculateTotal()}</h3>
          <button onClick={placeOrder}>Place Order</button>
        </div>
